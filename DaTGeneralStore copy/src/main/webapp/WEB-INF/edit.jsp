...
<div style="padding:20px ;">
    <form:form action="/datclassifieds/product/update/${product.id}" method="post" modelAttribute="newProduct">
        <input type="hidden" name="_method" value="put">

        <div class="form-group">
            <form:label path="category">Categories</form:label>
            <form:select path="category" class="form-control" value="${product.category}" aria-placeholder="${product.category}">
